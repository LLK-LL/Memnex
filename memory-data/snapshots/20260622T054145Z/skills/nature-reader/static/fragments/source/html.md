...
- Figures and tables are usually separate image/HTML elements 鈥?capture each figure image and its caption, and place per `references/figure-extraction.md`. Reconstruct HTML tables faithfully rather than screenshotting them when the markup is clean.
