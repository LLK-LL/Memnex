...
**v2.0** 路 Updated 2026-05-28 路 A structural upgrade integrating Microsoft Research's [SkillLens](https://arxiv.org/abs/2605.23899) and [SkillOpt](https://arxiv.org/abs/2605.23904) papers.
...
> [!NOTE]
> **馃 Microsoft Research lists darwin-skill as an official SkillOpt integration.**
...
> We absorbed its validation-gated framework; it added darwin to its integration list. A two-way nod. 馃憠 [Visit the SkillOpt repo](https://github.com/microsoft/SkillOpt)
...
**1. Rubric expanded from 8 鈫?9 dimensions** (integrating [SkillLens](https://arxiv.org/abs/2605.23899)'s empirically validated 73.8% rubric recipe)
...
- Phase 2 single-dimension edit: 馃敶 CHECKPOINT mandatory pause for user confirmation
- Phase 2.5 test-prompt run (optional)
- Phase 3 regression test: 馃洃 STOP if gain falls below threshold
...
- huashu-gpt-image skill: **80.8 鈫?91.5 鈫?91.65** (+10.85, consensus across 6 independent judges)
- darwin-skill self-eval: **86.05 鈫?92.05 鈫?92.7**
...
Evaluate 鈫?Improve 鈫?Test 鈫?Human Confirm 鈫?Keep or Revert. Repeat.
...
5. Score up 鈫?keep. Score down 鈫?`git revert` (never `git reset --hard`, blacklist #2)
6. Round gain < 1 point 鈫?early-stop automatically (no padding for score)
7. 馃敶 CHECKPOINT pauses, shows diff + score delta, waits for human confirmation
...
- 馃 **Mutual recognition**: On 2026-06-03, the official SkillOpt repo listed darwin-skill as an integration: *"gbrain, gbrain-evals, and darwin-skill have all integrated SkillOpt."* They give us the framework; we give it real-world validation.
...
**The key difference between darwin and SkillOpt**: SkillOpt is fully autonomous; darwin.skill emphasizes human-in-the-loop 鈥?skill quality is more subjective than validation loss. Critical phases (baseline eval, single-dimension edit, regression test) mandatorily pause for the human to make the final judgment.
...
| | |
|:---|:---|
| 馃寪 Website | [bookai.top](https://bookai.top) 路 [huasheng.ai](https://www.huasheng.ai) |
| 饾晱 Twitter | [@AlchainHust](https://x.com/AlchainHust) |
| 馃摵 Bilibili | [鑺卞彅](https://space.bilibili.com/14097567) |
| 鈻讹笍 YouTube | [@Alchain](https://www.youtube.com/@Alchain) |
| 馃摃 Xiaohongshu | [鑺卞彅](https://www.xiaohongshu.com/user/profile/5abc6f17e8ac2b109179dfdf) |
| 馃挰 WeChat | Search "鑺卞彅" |
