...
```text
浜や簰寮忓紩鐢ㄦ祻瑙堝櫒
- [absolute path to citation_visualization.html]  鈫?鍦ㄦ祻瑙堝櫒涓墦寮€姝ゆ枃浠讹紝鍙瓫閫?閫夋嫨/涓嬭浇寮曠敤
...
# REDACTED: sensitive-looking memory line
  - 鏀拺绛夌骇: [strong/partial/background/limiting/metadata-only]
  - 鎻掑叆寤鸿: [e.g. after sentence / after clause]
