...
**Self-contained skill** 鈥?can be used standalone on any academic text, or as
...
This is the **primary deliverable** 鈥?produce `paper_rewriting_output/humanize_matrix.md`.
...
- Write rows **during writing**, one per unit processed 鈥?not after the fact
...
- Fill all 8 columns for every row 鈥?no empty cells
