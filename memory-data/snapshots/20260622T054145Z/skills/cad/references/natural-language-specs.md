...
- Body: rounded rectangular plate, 100 脳 60 脳 6 mm.
- Corner radius: not specified; assume 3 mm.
- Holes: four 4.5 mm M4 clearance through-holes, 10 mm in from each corner.
- Cutout: centered rectangular through-cut, 20 脳 12 mm.
- Validation: one positive-volume solid, bbox 100 脳 60 脳 6 mm, four holes, one center cutout, label mounting_plate.
...
- Base: hollow lower shell, exterior 120 脳 80 mm footprint; height derived from total height minus lid thickness.
...
- Validation: labeled base and lid children, bbox near 120 脳 80 脳 35 mm, aligned hole/boss axes, Explorer link returned.
```
