...
```text
root component
鈫?part-local coordinate systems
鈫?named datums / joint locations
鈫?source-level build123d joints or explicit parameterized Locations
鈫?labeled Compound assembly
鈫?refs/measure/frame/mate validation
```
...
```text
Positioning/joints:
- source used RigidJoint lid_seat 鈫?underside
