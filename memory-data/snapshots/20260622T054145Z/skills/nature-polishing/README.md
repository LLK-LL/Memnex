...
鈹溾攢鈹€ README.md
鈹斺攢鈹€ references/
    鈹溾攢鈹€ published-article-patterns.md
    鈹溾攢鈹€ phrasebank-playbook.md
    鈹溾攢鈹€ section-moves.md
    鈹溾攢鈹€ style-guardrails.md
    鈹溾攢鈹€ writing-strategy.md
    鈹斺攢鈹€ latex-layout.md
```
...
- fixing LaTeX layout/typesetting (鎺掔増): loose or sparse pages, stranded section headings, figures that don't fill the page or split across pages, "Float too large", multi-panel arrangement, sparse Supplementary Information
...
- `latex-layout.md`: LaTeX float/page typesetting 鈥?top-aligned float glue, the `\clearpage`+`[H]` heading-figure unit, `placeins` caveats, regenerating wide-and-short figures taller at the source, multi-panel stacking, and a render-and-contact-sheet diagnosis workflow
