...
2. Reconstruct explicit logical links: contrast, cause, implication, limitation. Chinese academic prose often elides these connectives 鈥?restore them.
...
- Strings of short clauses joined by commas 鈥?split or add connectives.
- Vague generalizations (`many studies have shown`) 鈥?convert to specific citations or remove.
