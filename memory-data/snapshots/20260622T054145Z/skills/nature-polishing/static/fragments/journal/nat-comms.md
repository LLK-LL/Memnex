...
These are diagnostic, not destructive 鈥?surface the problem in `Revision notes:` rather than silently cutting.
...
- "What's the reference style?" 鈫?cite the format example from shared
- "How many figures can I have?" 鈫?cite the 10-item cap from shared
- "What's the abstract limit?" 鈫?150 words, unstructured, no citations
