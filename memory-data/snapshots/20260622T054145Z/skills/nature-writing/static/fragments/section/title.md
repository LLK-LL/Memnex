...
- Be substantiated by data 鈥?if a number or quantitative word appears, verify it against the manuscript.
- Create curiosity without sacrificing credibility. A hook is only acceptable if the claim remains fully defensible.

## Things to avoid

- Grant-style aims (`Toward 鈥, `A study of 鈥).
- Overbroad field claims (`A new era of 鈥, `Revolutionizing 鈥).
