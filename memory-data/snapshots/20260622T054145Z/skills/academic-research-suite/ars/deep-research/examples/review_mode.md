...
1. `editor_in_chief_agent` 鈥?Academic quality and argumentation review
2. `ethics_review_agent` 鈥?Ethics and fairness review
3. `devils_advocate_agent` 鈥?Counter-arguments and challenges
