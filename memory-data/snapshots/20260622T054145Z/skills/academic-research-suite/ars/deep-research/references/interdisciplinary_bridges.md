# Interdisciplinary Bridges 鈥?Cross-Discipline Connection Patterns
...
|--------|--------|-----------|
| Disruptive Innovation (Christensen) | Business 鈫?Education, Healthcare |
| Actor-Network Theory (Latour) | Sociology of Science 鈫?Information Systems, Education |
| Ecological Systems (Bronfenbrenner) | Developmental Psychology 鈫?Education, Social Work |
| Diffusion of Innovations (Rogers) | Communication 鈫?Health, Technology, Education |
| Institutional Theory (DiMaggio/Powell) | Sociology 鈫?Management, Education Policy |
| Complex Adaptive Systems | Biology 鈫?Management, Healthcare, Education |
| Game Theory | Mathematics 鈫?Economics, Political Science, Biology |
| Nudge Theory (Thaler/Sunstein) | Behavioral Economics 鈫?Public Policy, Health, Education |
...
1. Understand the full context of the methodology in its original field (don't just learn the steps 鈥?understand why it was designed this way)
...
- Ask yourself: Who else is dealing with a similar problem? (Education 鈫?Economists also study human capital)
- Ask yourself: What are the upstream/downstream aspects of this problem? (University admissions 鈫?upstream is secondary education, downstream is the labor market)

**Step 3: Find one classic reference in each discipline**
- You don't need the most recent 鈥?find the most cited (Google Scholar sorted by citations)
...
**Step 4: Ask 鈥?"How would someone in this discipline view my problem?"**
...
- You don't need to go deep into every discipline 鈥?finding one valuable borrowing is enough
...
- You don't need to present a paper 鈥?just attend and listen
...
- Cross-disciplinary highlights:
  ...
  - **Law and Society**: Law is not just statutes 鈥?it is social practice; how law is actually used, circumvented, and experienced
  - **Technology Law**: AI regulation, personal data protection, platform governance 鈥?how law responds to technological change
