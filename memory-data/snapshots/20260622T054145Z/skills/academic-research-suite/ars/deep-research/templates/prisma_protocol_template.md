# PRISMA-P 2015 鈥?Systematic Review Protocol Template
...
**Primary outcome(s)**:
1. [Outcome 1] 鈥?measured by [instrument/method], at [time point(s)]
2. [Outcome 2] 鈥?measured by [instrument/method], at [time point(s)]

**Secondary outcome(s)**:
1. [Outcome 3] 鈥?measured by [instrument/method], at [time point(s)]
2. [Outcome 4] 鈥?measured by [instrument/method], at [time point(s)]
...
| [Grey literature] | [specify sources] | 鈥?| Reduce publication bias |
| [Trial registries] | clinicaltrials.gov, WHO ICTRP | 鈥?| Identify unpublished studies |
...
**Conditions for meta-analysis**: [Describe when studies will be pooled, e.g., "When 鈮?3 studies report sufficiently similar outcomes measured in comparable populations"]
...
- I虏 statistic with 95% CI
- tau虏 (between-study variance)
- Prediction interval

**Subgroup analyses** (pre-specified):
1. [Subgroup variable 1] 鈥?Rationale: [why]
2. [Subgroup variable 2] 鈥?Rationale: [why]
...
**Publication bias**: [Methods to assess, e.g., funnel plot + Egger's test if 鈮?10 studies]
