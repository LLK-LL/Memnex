#!/usr/bin/env python3
"""Enforce the v3.6.6 A/B evidence fixture manifest contract per 搂6.2 schema +
搂6.5 git-tracked invariants per design doc 2026-04-27-ars-v3.6.6-generator-evaluator-contract-design.md.

Three rule families per spec body 搂7.5:
...
def _check_schema_shape(manifest: dict) -> list[str]:
    """Schema-shape checks per 搂6.2 + 搂7.5. Returns list of error messages."""
    errors: list[str] = []
