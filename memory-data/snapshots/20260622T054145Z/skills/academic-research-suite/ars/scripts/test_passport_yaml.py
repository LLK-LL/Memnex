#!/usr/bin/env python3
"""Tests for `scripts/_passport_yaml.py` 鈥?shared ruamel.yaml round-trip
configuration extracted from `migrate_literature_corpus_to_v3_7_3.py` and
`migrate_literature_corpus_to_v3_9_0.py` (#128 v3.9.1 housekeeping 搂5).
...
class RoundTripTest(unittest.TestCase):
    """Verify load 鈫?dump preserves the spec-aligned indentation shape."""
    ...
    def test_round_trip_sequence_indent_is_4(self) -> None:
        """Per spec convention: sequence indent = 4, offset = 2 鈫?list
