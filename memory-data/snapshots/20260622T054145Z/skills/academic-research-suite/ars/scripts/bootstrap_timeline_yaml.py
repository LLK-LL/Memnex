#!/usr/bin/env python3
"""v3.9.4 opt-in bootstrap script 鈥?populate timeline.yaml from literature_corpus[].
...
# requests is optional 鈥?only needed when not --dry-run
try:
    import requests
except ImportError:
    requests = None
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="v3.9.4 bootstrap_timeline_yaml.py 鈥?opt-in Crossref + pdftotext")
