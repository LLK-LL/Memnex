...
docs/design/2026-05-14-ai-disclosure-impl-spec.md 搂4.1 (policy_anchor_table
lint scope) and 搂4.4 #11 (G1 scope-narrowing).
"""
...
_GOOD_TABLE = textwrap.dedent(
    ...
    **Snapshot:** `prisma-trAIce:wayback=20260513075443` (sha256: f95fc59f鈥?
    ...
    | 9 | Human oversight method | explicit-recommend | "Describe the process of human interaction with and oversight of the AI tool(s) at each stage." | Table 1, M8.a鈥揼 | narrative |
    ...
    **Snapshot:** `icmje:wayback=20260513075516` (sha256: 52f9e6bc鈥?
    ...
    | # | Field | Source strength | Verbatim quote | Locator | Value type |
    |---|---|---|---|---|---|
    | 1 | AI tool name | implicit | (inference passage) Tool identity implied. | 搂V.A, paragraph 1 | narrative |
    | 2 | AI tool version | not-addressed | 鈥?| 鈥?| 鈥?|
    | 3 | AI tool developer / manufacturer | not-addressed | 鈥?| 鈥?| 鈥?|
    | 4 | Stage / phase of use | implicit | (inference passage) "How they used it" implies stage. | 搂V.A, paragraph 1 | narrative |
    | 5 | Specific task within stage | implicit | (inference passage) Same as #4 source. | 搂V.A, paragraph 1 | narrative |
...
# REDACTED: sensitive-looking memory line
    | 15 | Copyediting exemption predicate | not-addressed | 鈥?| 鈥?| 鈥?|
    | 16 | AI-generated image / figure / content rights | explicit-mandate | "Humans must ensure there is appropriate attribution of all quoted material, including full citations." | 搂V.A, paragraph 1 | narrative |
...
# REDACTED: sensitive-looking memory line
# REDACTED: sensitive-looking memory line
    | 16 | AI-generated image / figure / content rights | explicit-mandate | "Springer Nature journals are unable to permit its use for publication." | 搂Generative AI images | narrative |
...
class CheckPolicyAnchorTableInvariantTest(unittest.TestCase):
    ...
    4 canonical anchor slugs, matching the discovery doc 搂4.2 field list and
    搂4.3-4.6 anchor inventory.
    """
