...
Configuration:
- preserve_quotes = True 鈫?keeps single vs double quoting choice.
- indent(mapping=2, sequence=4, offset=2) 鈫?sequence items align with `- `
...
# key order, and quoting style across read 鈫?mutate 鈫?write.
_yaml = YAML()
