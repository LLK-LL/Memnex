#!/usr/bin/env python3
"""v3.9.4 spec lint 鈥?temporal verification sidecar conformance.

Enforces 8 invariants from spec 搂7:
...
BIBLIOGRAPHY_AGENT_SHA256 = "1d34ef9cfcd26afebebd19ee199ff1c5b1d4364dd79a1a2de5e5220a060539f4"  # v3.9.3 baseline; F2 invariant per spec 搂3.4 + 搂3.6
...
def _check_bibliography_agent_unchanged() -> list[str]:
    ...
    Per spec 搂3.4 + 搂3.6 F2 closure: M6 citation provenance and M5-stub version-family awareness
    ...
    if actual != BIBLIOGRAPHY_AGENT_SHA256:
        return [
            f"bibliography_agent.md modified 鈥?v3.9.4 F2 invariant violated. "
            f"expected sha256 {BIBLIOGRAPHY_AGENT_SHA256}, got {actual}. "
            f"Per spec 搂3.4 + 搂3.6, M6 citation provenance and M5-stub version-family awareness "
