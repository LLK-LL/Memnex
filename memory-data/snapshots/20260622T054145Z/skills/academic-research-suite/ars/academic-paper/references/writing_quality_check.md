...
The following terms appear disproportionately in AI-generated text. They are not banned 鈥?but when you encounter one, ask: **"Is this really the most precise word here, or am I defaulting to it?"**
...
| tapestry | Clich茅 metaphor for complexity | network, interplay, system, landscape |
...
| testament | Clich茅 | evidence, indicator, demonstration |
...
| cornerstone | Clich茅 metaphor | foundation, basis, core element, pillar |
...
| cutting-edge | Clich茅 | recent, advanced, state-of-the-art, novel |
...
- "paradigm shift" in philosophy of science 鈫?OK
- "landscape" in ecology/geography (literal) 鈫?OK
- "robust" in statistics ("robust estimator") 鈫?OK
- "navigate" in wayfinding research (literal) 鈫?OK
...
### Em Dash (鈥?
- **Limit**: 鈮?3 per paper total, recommend 0-1
...
| "In today's rapidly evolving..." | Delete. Timestamped clich茅s add no information |
...
- "This section will discuss..." 鈫?Just discuss it
- "The following paragraph examines..." 鈫?Just examine it
- "We now turn our attention to..." 鈫?Just turn to it
...
- **Why**: In academic writing, consistent terminology is a virtue. Swapping "students" 鈫?"learners" 鈫?"participants" 鈫?"subjects" within one paragraph confuses rather than impresses
- **Fix**: Pick one term per concept per section. Repeat it. Technical repetition is clarity, not weakness

### Binary Contrast Overuse
- **Pattern**: "Not X. Y." or "It's not about X 鈥?it's about Y." used more than twice per paper
- **Why**: This rhetorical device is effective once. Repeated, it becomes a tic
- **Limit**: 鈮?2 per paper

### Mirror Structure
- **Pattern**: Every section has the same internal structure (topic sentence 鈫?3 evidence points 鈫?synthesis sentence)
...
### How to Fix
- Insert a short sentence (鈮?10 words) to break the pattern
- Combine two short sentences into one complex one if the pattern is monotonously short
- Read the paragraph aloud 鈥?if it feels metronomic, vary it
...
- 0 violations: Clean
- 1-3 violations: Minor 鈥?fix in self-review
- 4+ violations: Pattern issue 鈥?review the section's writing approach
