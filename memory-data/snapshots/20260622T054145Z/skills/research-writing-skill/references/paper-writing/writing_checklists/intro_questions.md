...
- [ ] Does the paper have a **named abstraction** 鈥?a coined term that captures the core insight?
...
- [ ] Does the introduction promise **exactly** what the evaluation delivers 鈥?no more, no less? (Principle 1)
