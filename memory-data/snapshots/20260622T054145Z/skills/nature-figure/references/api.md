# API Reference 鈥?Nature Figure Making
...
def apply_publication_style(font_size=16, axes_linewidth=2.5, use_tex=False):
    ...
    # 鈹€鈹€ MANDATORY: editable SVG text 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
    plt.rcParams['font.family'] = 'sans-serif'
    plt.rcParams['font.sans-serif'] = ['Arial', 'DejaVu Sans', 'Liberation Sans']
    plt.rcParams['svg.fonttype'] = 'none'
    # 鈹€鈹€ Layout & style 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
def make_grouped_bar(ax, categories, series, labels,
    ...
    ----------
    ax         : matplotlib Axes
    categories : list[str]  鈥?x-axis category names (length K)
    series     : list[array] 鈥?one array per group (each length K)
    labels     : list[str]  鈥?legend label per group
    ylabel     : str
    colors     : list[str] | None  鈥?defaults to DEFAULT_COLORS; override with
                                     DEFAULT_COLORS_NMI_PASTEL for unified-family figures
    annotate   : bool  鈥?print value above each bar
    bar_width  : float 鈥?total width for all bars in one category
    error_kw   : dict  鈥?passed to ax.bar as error_kw
...
def make_trend(ax, x, y_series, labels,
    ...
    Parameters
    ----------
    x        : array-like   鈥?shared x values
    y_series : list[array]  鈥?one 1D array per line
    labels   : list[str]
    show_shadow : bool  鈥?fill_between 卤 std if y_series contains 2D arrays (rows=runs)
    """
    import numpy as np
    if colors is None:
        colors = DEFAULT_COLORS
...
def finalize_figure(fig, out_path, formats=None, dpi=300,
    ...
    Parameters
    ----------
    out_path : str   鈥?path without extension, or with extension
    formats  : list  鈥?e.g. ['png', 'pdf']. If None, uses extension of out_path.
    dpi      : int   鈥?300 standard, 600 for dense bar panels
    pad      : float 鈥?tight_layout pad (2 default, 1 for compact multi-panel)
    """
    import os
...
- `finalize_figure`: supported formats 鈥?`png`, `pdf`, `svg`, `eps`, `jpg`, `tif`.
