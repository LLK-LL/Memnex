...
```
nature-figure/
鈹溾攢鈹€ SKILL.md                     鈫?short router: backend gate, load fragments
鈹溾攢鈹€ manifest.yaml                鈫?always_load core + backend axis + on-demand references
鈹溾攢鈹€ README.md                    鈫?this file
鈹溾攢鈹€ static/
鈹?  鈹溾攢鈹€ core/                    鈫?always loaded
鈹?  鈹?  鈹溾攢鈹€ contract.md          鈫?figure contract, backend gate, exclusivity, missing-runtime
鈹?  鈹?  鈹斺攢鈹€ stance.md            鈫?color policy, default stance, privacy, when-to-load
鈹?  鈹斺攢鈹€ fragments/
鈹?      鈹斺攢鈹€ backend/             鈫?loaded after the Python-or-R gate is resolved
鈹?          鈹溾攢鈹€ python.md        鈫?Python-only rule + matplotlib quick-start
鈹?          鈹斺攢鈹€ r.md             鈫?R-only rule + ggplot2 quick-start
鈹溾攢鈹€ assets/
鈹?  鈹溾攢鈹€ gallery/                 鈫?result-figure preview PNGs
鈹?  鈹溾攢鈹€ chart-atlas/             鈫?chart-type taxonomy preview PNGs
鈹?  鈹斺攢鈹€ figures4papers/          鈫?original demo scripts and preview assets
鈹斺攢鈹€ references/                  鈫?opened on demand
    鈹溾攢鈹€ figure-contract.md       鈫?core conclusion, evidence hierarchy, panel map
    鈹溾攢鈹€ backend-selection.md     鈫?Python vs R decision rules
    鈹溾攢鈹€ r-workflow.md            鈫?R scaffold, patchwork, ComplexHeatmap, export
    鈹溾攢鈹€ r-template-index.md      鈫?local R template atlas
    鈹溾攢鈹€ qa-contract.md           鈫?submission/revision QA checklist
    鈹溾攢鈹€ api.md                   鈫?PALETTE constants, helper function signatures
    鈹溾攢鈹€ design-theory.md         鈫?typography, color theory, layout, export policy
    鈹溾攢鈹€ common-patterns.md       鈫?reusable code patterns (bars, legends, heatmaps)
    鈹溾攢鈹€ tutorials.md             鈫?end-to-end walkthroughs
    鈹溾攢鈹€ chart-types.md           鈫?radar, 3D sphere, scatter, fill_between, log-scale
    鈹斺攢鈹€ demos.md                 鈫?figures4papers demo map and routing guide
```
...
### 1. Three required rcParams 鈥?editable SVG text
...
visually identical but every `<text>` element becomes a `<path d="M...">` 鈥?unselectable,
...
```python
fig.savefig('figure.svg', bbox_inches='tight')        # primary 鈥?editable text
...
# 鈹€鈹€ MANDATORY 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
plt.rcParams['font.family'] = 'sans-serif'
plt.rcParams['font.sans-serif'] = ['Arial', 'DejaVu Sans', 'Liberation Sans']
plt.rcParams['svg.fonttype'] = 'none'

# 鈹€鈹€ Style 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
plt.rcParams.update({
    'font.size': 12,
...
# 鈹€鈹€ Figure 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
PALETTE_NMI_PASTEL = {
    ...
    # Hero / proposed family (lilac 鈫?rose)
    'ours_tiny':  '#E4E4F0',
    'ours_base':  '#E4CCD8',
    'ours_large': '#F0C0CC',
...
| Heatmap (diverging / z-score) | `design-theory.md 搂11` | `RdBu_r`, `vmin=-2.5, vmax=2.5` |
| Bubble scatter | `design-theory.md 搂11` | x/y = two compartments, `s=` = third variable |
...
| Type | `figsize` |
|------|-----------|
| Multi-metric bar (3鈥? metrics + legend panel) | `(28鈥?5, 6鈥?2)` |
| Grand multi-panel (3 panels, 2-row GridSpec) | `(22, 17)` |
| Compact single bar | `(9鈥?6, 5鈥?)` |
| Trend / line multi-panel | `(14, 4)` or `(9, 8)` |
| Heatmap single | `(8鈥?0, 5鈥?)` |
| Radar polar | `(12, 10)` |

**Rule**: width 鈮?3鈥?脳 height for comparison bar panels.
...
| Context | `font.size` |
|---------|-------------|
| Base (compact subfigures) | 12鈥?6 |
| Large bar panels (figsize > 28 in) | 24 |
| Axis labels (large panels) | 32鈥?4 via per-label override |
| In-bar / in-cell annotations | 6.5鈥?2 |
| Panel letter labels | 20鈥?2 |
| Legend | 8鈥?4 |
...
Y-limits tightened to data range 鈥?never use `0鈥?00` when all values sit in `80鈥?5`.
...
- [ ] **Lines 1鈥?**: `font.family`, `font.sans-serif` (three fonts), `svg.fonttype = 'none'`
- [ ] Primary output is **SVG** (`bbox_inches='tight'`)
- [ ] Right and top spines off; `legend.frameon = False`
- [ ] Font size matches final use: 5鈥? pt for dense journal output, larger only for slide-sized panels
