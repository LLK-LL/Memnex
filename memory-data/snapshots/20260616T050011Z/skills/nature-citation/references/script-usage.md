...
5. **Minimize inline analysis.** For long articles, do NOT write detailed support-grade notes for every single segment inline. Instead:
   - Write a compact summary table (segment ID 鈫?best candidate 鈫?support grade).
...
| Segments | Strategy |
|---|---|
| 1鈥?0 | Run once, full inline analysis is fine. |
| 11鈥?5 | Use `--batch-size 10`. Write a compact summary table. Point to HTML. |
