...
**Post-evaluation placement** (most systems papers): Related work appears AFTER the evaluation. This is a confidence signal 鈥?"you'll understand why existing work is insufficient only after seeing our results." Use when novelty is primarily empirical.
...
**Function**: Group prior work into 2鈥? categories, each with a named limitation.
...
3. **Missing the positioning sentence**: Without it, reviewers will ask "how is this different from X?" Don't make them guess 鈥?state it explicitly.
