...
AI Builders Digest 鈥?[Date]

Then organize content in this order:

1. X / TWITTER section 鈥?list each builder with new posts
2. PODCASTS section 鈥?list each podcast with new episodes
...
- Keep formatting clean and scannable 鈥?this will be read on a phone screen
