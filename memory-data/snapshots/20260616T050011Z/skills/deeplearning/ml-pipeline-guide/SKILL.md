...
```
Data Ingestion 鈫?Feature Engineering 鈫?Training 鈫?Evaluation 鈫?Artifact Storage
     鈹?                 鈹?                鈹?           鈹?             鈹?     鈹溾攢鈹€ raw data       鈹溾攢鈹€ transforms    鈹溾攢鈹€ model    鈹溾攢鈹€ metrics    鈹溾攢鈹€ models
     鈹溾攢鈹€ splits         鈹溾攢鈹€ features      鈹溾攢鈹€ logs     鈹溾攢鈹€ plots      鈹溾攢鈹€ configs
     鈹斺攢鈹€ metadata       鈹斺攢鈹€ cache         鈹斺攢鈹€ ckpts    鈹斺攢鈹€ tables     鈹斺攢鈹€ reports
```
...
project/
鈹溾攢鈹€ configs/
鈹?  鈹溾攢鈹€ base.yaml           # Default hyperparameters
鈹?  鈹溾攢鈹€ experiment_001.yaml  # Experiment-specific overrides
鈹?  鈹斺攢鈹€ sweep.yaml          # Hyperparameter search space
鈹溾攢鈹€ data/
鈹?  鈹溾攢鈹€ raw/                # Immutable original data
鈹?  鈹溾攢鈹€ processed/          # Cleaned and transformed
鈹?  鈹斺攢鈹€ splits/             # Train/val/test splits (versioned)
鈹溾攢鈹€ src/
鈹?  鈹溾攢鈹€ data/               # Data loading and preprocessing
鈹?  鈹溾攢鈹€ features/           # Feature engineering
鈹?  鈹溾攢鈹€ models/             # Model definitions
鈹?  鈹溾攢鈹€ training/           # Training loops
鈹?  鈹斺攢鈹€ evaluation/         # Metrics and visualization
鈹溾攢鈹€ experiments/            # MLflow/W&B experiment logs
鈹溾攢鈹€ notebooks/              # Exploratory analysis only
鈹溾攢鈹€ tests/                  # Unit tests for pipeline components
鈹溾攢鈹€ Makefile                # Reproducible commands
鈹溾攢鈹€ requirements.txt        # Pinned dependencies
鈹斺攢鈹€ dvc.yaml                # Data version control pipeline
```
