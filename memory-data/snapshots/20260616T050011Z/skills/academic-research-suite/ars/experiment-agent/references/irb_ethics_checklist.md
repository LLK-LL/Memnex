...
- Any NEEDS_ACTION in categories 1-3 鈫?ethics_status: ETHICS_BLOCKED
- Any applicable NEEDS_ACTION in category 4 鈫?ethics_status: ETHICS_BLOCKED
- Category 5.1 missing required approval/exemption 鈫?ethics_status: ETHICS_PENDING
- Any NEEDS_ACTION in category 5.2-6.4 鈫?ethics_status: ETHICS_PENDING
...
- All required items PASS or NOT_APPLICABLE, and institutional approval is `Approved` or `Exempt` when required 鈫?ethics_status: READY
