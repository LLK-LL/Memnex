...
- **Action**: ADVISORY 鈥?notify user, suggest continue/kill/adjust
...
- **Action**: ADVISORY 鈥?show metric trend, suggest early stopping
...
- **Action**: ADVISORY 鈥?possible memory leak, suggest investigation
...
- **Action**: ADVISORY 鈥?show current rate, revised ETA
...
- **Action**: MANDATORY 鈥?kill process (SIGTERM, then SIGKILL after 10s), collect stderr, report
...
- Maximum: 300 seconds (5 minutes 鈥?longer gaps risk missing transient failures)
