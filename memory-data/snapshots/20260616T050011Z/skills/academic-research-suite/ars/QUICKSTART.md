...
Claude will enter Socratic mode 鈥?asking questions to help you clarify your thinking, not giving you answers directly. After 5-15 rounds of dialogue, you'll have a focused research question and methodology direction.
...
### Example: Full pipeline (research 鈫?write 鈫?review 鈫?revise 鈫?publish)
...
| I want to... | Use this |
|-------------|----------|
| Explore a vague idea | `deep-research` socratic mode 鈥?just describe your interest |
...
| Do everything end-to-end | `academic-pipeline` 鈥?say "I want a complete research paper" |

## What's next?

- [Full README](README.md) 鈥?all features, modes, installation options, and changelog
- [涓枃鐗圿(README.zh-TW.md) 鈥?Traditional Chinese version
- [Pipeline showcase](examples/showcase/) 鈥?real artifacts from a complete pipeline run
