...
See design doc 搂5.3. Users who want a live-sync API-based variant are
...
# are ambiguous and must be rejected 鈥?the year may be in a non-standard position.
...
# REDACTED: sensitive-looking memory line
        ...
        # Design 搂398-399: source_pointer must be a real Zotero URI 鈥?either
