    ...
    return {
        ...
        "raise": {
            ...
            "principle_evidence": {
                ...
                "transparency": ["manuscript 搂Methods L40"],
                "reproducibility": ["passport.repro_lock"],
                "fit_for_purpose": ["Stage 1: scoping.md L5"],
            },
            "roles": {
                "evidence_synthesists": ["manuscript 搂Acknowledgements"],
...
def _valid_primary_report() -> dict:
    ...
    return {
        ...
        "raise": {
            ...
            "principle_evidence": {
                "human_oversight": ["manuscript 搂Limitations"],
                "transparency": [],
                "reproducibility": ["manuscript 搂Methods"],
                "fit_for_purpose": ["manuscript 搂Introduction"],
            },
            "block_decision": "warn",
        },
