...
Per spec 搂5.4 strict-monotonic helper:
...
搂10 Phase 6.4 verification gate: "_next_verified_at_ms() always returns a
...
class TestNextVerifiedAtMs(unittest.TestCase):
    """Pure-function behaviour per 搂5.4 / 搂10 cases (a)-(d)."""
...
class TestStrictMonotonicProperty(unittest.TestCase):
    """搂10 verification gate: result strictly greater than every prior entry."""
...
class TestCli(unittest.TestCase):
    """CLI invocation per 搂10 Phase 6.4 deliverables (--passport <path>)."""
    ...
    def test_cli_with_unquoted_timestamps_does_not_crash(self) -> None:
        # Spec 搂3.1 example uses unquoted timestamps. PyYAML's default loader
