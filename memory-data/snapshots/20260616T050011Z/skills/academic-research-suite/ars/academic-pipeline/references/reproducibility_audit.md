...
| Consistent review angles | EIC + R1/R2/R3 + Devil's Advocate 鈥?five fixed perspectives |
...
This document defines PROCESS reproducibility 鈥?consistent stages, fixed reviewer angles,
explicit pass/fail thresholds. That's one of two meanings of "reproducible."

The other is COMPUTATIONAL re-run 鈥?could a third party re-execute the same pipeline and
