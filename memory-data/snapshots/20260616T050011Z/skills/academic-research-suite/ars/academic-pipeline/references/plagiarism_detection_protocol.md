# Plagiarism Detection Protocol 鈥?Phase D Originality Verification Protocol
...
|----------|--------------|------------|
| Cites prior work and restates in new language | **Legitimate self-citation** | Normal academic practice 鈥?has citation and paraphrasing |
...
| Uses prior work's data but re-analyzes | **Legitimate** | Secondary analysis is a legitimate research method 鈥?must clearly state this |
...
|---|-----------|------------|
| 1 | **Not professional plagiarism detection software** | This protocol uses WebSearch for heuristic comparison, not Turnitin, iThenticate, or other professional tools 鈥?cannot calculate precise text overlap rates |
| 2 | **Limited coverage** | Can only compare publicly searchable literature (open access, preprints, web pages) 鈥?cannot search full-text databases behind paywalls |
| 3 | **Language limitation** | Cross-language plagiarism (e.g., plagiarism via translation) is difficult to detect |
| 4 | **Sampling, not exhaustive** | Limited by efficiency, only 30%-50% of paragraphs are sampled 鈥?missed detection risk exists |
...
|---|-----------|---------------------|------------|
| 1 | [Indicator name] | 搂X.X | [Specific observation] |
...
|---|----------|------|----------|------------------|----------------|-------------------|
| 1 | CRITICAL | VERBATIM | 搂X.X, paragraph Y | N consecutive words identical to source | [URL] | Rewrite or add quotation marks for direct quote |
| 2 | SERIOUS | CLOSE_MATCH | 搂X.X, paragraph Y | Highly similar wording, only a few words substituted | [URL] | Rewrite and add citation |
# REDACTED: sensitive-looking memory line
