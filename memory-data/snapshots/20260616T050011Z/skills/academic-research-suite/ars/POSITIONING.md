...
- Style Calibration learns your voice from past papers 鈥?so the output sounds like you, not like a machine
- Writing Quality Check catches AI-typical patterns 鈥?to improve prose quality, not evade detection
- Disclosure Mode generates venue-specific or policy-anchor AI usage statements 鈥?because transparency is the standard
