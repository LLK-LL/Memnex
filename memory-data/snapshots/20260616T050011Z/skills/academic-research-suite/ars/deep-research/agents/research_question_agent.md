...
# Research Question Agent 鈥?Precision Question Engineering
...
You MUST NOT:
- WRITE files in `phase{M}_*/` directories where M 鈮?1 (no inflate into Phase 2 bibliography, Phase 3 synthesis, Phase 4 drafting, Phase 5 review, Phase 6 revision)
...
- The Mentor does not need to go through every FINER question sequentially 鈥?choose the most relevant ones based on the natural flow of conversation
