...
User Input
    鈹?
    鈹溾攢鈹€ Have a clear research question?
    鈹?  鈹溾攢鈹€ Yes 鈹€鈹€鈫?Have a text to review?
    鈹?  鈹?           鈹溾攢鈹€ Yes 鈹€鈹€鈫?review mode
    鈹?  鈹?           鈹斺攢鈹€ No 鈹€鈹€鈹€鈫?Need PRISMA-compliant systematic review / meta-analysis?
    鈹?  鈹?                        鈹溾攢鈹€ Yes 鈹€鈹€鈫?systematic-review mode
    鈹?  鈹?                        鈹斺攢鈹€ No 鈹€鈹€鈹€鈫?Need a complete report?
    鈹?  鈹?                                    鈹溾攢鈹€ Yes 鈹€鈹€鈫?full mode
    鈹?  鈹?                                    鈹斺攢鈹€ No 鈹€鈹€鈹€鈫?Only need literature?
    鈹?  鈹?                                                鈹溾攢鈹€ Yes 鈹€鈹€鈫?lit-review mode
    鈹?  鈹?                                                鈹斺攢鈹€ No 鈹€鈹€鈹€鈫?quick mode
    鈹?  鈹?
    鈹?  鈹斺攢鈹€ No 鈹€鈹€鈫?Want guided thinking?
    鈹?             鈹溾攢鈹€ Yes 鈹€鈹€鈫?socratic mode
    鈹?             鈹斺攢鈹€ No 鈹€鈹€鈹€鈫?full mode
    鈹?                         (Phase 1 interactive RQ clarification)
    鈹?
    鈹溾攢鈹€ Only need to verify specific facts?
    鈹?  鈹斺攢鈹€ Yes 鈹€鈹€鈫?fact-check mode
    鈹?
    鈹斺攢鈹€ Not sure what you need?
        鈹斺攢鈹€ Describe your situation 鈫?System auto-recommends a mode
```
...
銆屽紩灏庢垜鐨勭爺绌讹細楂樻暀鍝佷繚銆?
銆屽公鎴戦噽娓呮垜鐨勭爺绌舵柟鍚戙€?
銆屽公鎴戞兂鎯筹紝鎴戝皪灏戝瓙鍖栬椤屾湁鑸堣叮浣嗕笉纰哄畾瑕佺爺绌朵粈楹笺€?
銆屾垜鏈夊€嬫ā绯婄殑鎯虫硶锛屾兂鎵剧爺绌堕鐩€?
銆屽付鎴戝仛鐮旂┒銆?
```
...
| "I want to research X" / 銆屾垜鎯崇爺绌禭銆?but can't articulate what they want to know) | Research thinking clarification | `socratic`, not `full` | full mode's Phase 1 also offers interaction, but socratic goes deeper |
...
| "Help me think of a research topic" / 銆屽公鎴戞兂鐮旂┒椤岀洰銆?| Research direction exploration | `socratic` | Best suited for users without a clear direction |
...
```
socratic 鈫?full              Continue with complete research after Socratic completion
socratic 鈫?academic-paper    Write paper directly after Socratic completion
lit-review 鈫?full            Want complete analysis after literature review
lit-review 鈫?systematic-review  Need formal PRISMA compliance after initial lit survey
fact-check 鈫?full            Need deeper research after fact-checking
quick 鈫?full                 Worth going deeper after quick research
review 鈫?full                Need to re-research after review
systematic-review 鈫?academic-paper  Write up systematic review as a paper
```
...
### Transition: lit-review 鈫?systematic-review
...
### Transition: systematic-review 鈫?academic-paper
- **When**: Systematic review is complete and user wants to write it up as a journal article
- **Reusable**: Everything 鈥?PRISMA report is essentially the paper draft
- **Must Redo**: Formatting to target journal requirements, abstract restructuring
- **Quality Delta**: Minimal 鈥?systematic review output is already structured per PRISMA 2020

### Prohibited Transitions
- **full 鈫?quick**: Cannot downgrade a full research to quick brief (loss of rigor)
- **Any 鈫?socratic**: Socratic mode is an entry point only; cannot transition into it mid-pipeline
- **paper-review 鈫?full**: Paper review evaluates existing work; full mode creates new research. These are fundamentally different tasks
