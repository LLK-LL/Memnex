# IRB Decision Tree 鈥?Human Subjects Research Ethics Review Guide
...
鈹?
鈹溾攢鈹€ No 鈫?Does not involve human subjects, no IRB review needed
鈹?        (e.g., pure theoretical research, literature review, secondary analysis of public statistics)
鈹?
鈹斺攢鈹€ Yes 鈫?Is the data personally identifiable?
          鈹?
          鈹溾攢鈹€ No 鈫?Is the data publicly available public data?
          鈹?       鈹?
          鈹?       鈹溾攢鈹€ Yes 鈫?Typically exempt from review
          鈹?       鈹?        But must still submit an exempt review application to IRB for confirmation
          鈹?       鈹?
          鈹?       鈹斺攢鈹€ No 鈫?Proceed to "Review Level Determination" below
          鈹?
          鈹斺攢鈹€ Yes 鈫?Does the research involve direct interaction with subjects?
                    鈹?
                    鈹溾攢鈹€ No 鈫?Only uses existing data/specimens
                    鈹?       鈹?
                    鈹?       鈹溾攢鈹€ Data already de-identified 鈫?May apply for exempt review
                    鈹?       鈹斺攢鈹€ Data contains identifiable information 鈫?Expedited or full board review
                    鈹?
                    鈹斺攢鈹€ Yes 鈫?Proceed to "Review Level Determination" below
```
...
**Note**: Exempt review does not mean exempt from application 鈥?you must still submit to IRB to confirm exempt status.
...
鈻?I have read and understood the above explanation and agree to participate
  in this research.
...
| **Data generalization** | Convert precise values to ranges (e.g., age 鈫?age group) | Statistical analysis |
