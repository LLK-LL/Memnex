...
Provides a third bibliographic-index lookup for v3.9.0 cross-index triangulation per spec v3.9.0 搂3.5. Crossref is the DOI registry of record 鈥?strongest coverage for journal articles with DOIs. Monograph / chapter coverage is partial (publisher participation dependent). v3.9.0 surfaces `crossref_unmatched` as one of three signals; the user retains discretion per R-L3-2-A.
...
- Spec: `docs/design/2026-05-17-ars-v3.9.0-cross-index-triangulation-measurement-spec.md` 搂3.5
