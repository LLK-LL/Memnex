# Research Methodology Patterns 鈥?Design Templates
...
5. Two-pass screening (title/abstract 鈫?full text)
...
C. SWOT Analysis
D. Logic Model (Input 鈫?Activity 鈫?Output 鈫?Outcome 鈫?Impact)
...
Reporting Standards: QUAL strand 鈫?COREQ; QUAN strand 鈫?STROBE/CONSORT (see references/equator_reporting_guidelines.md)
```
...
4. Analyze codes 鈫?categories 鈫?themes
...
4. Open coding 鈫?axial coding 鈫?selective coding
...
5. Requirement Specification
   ...
   - Establish traceability matrix (requirements 鈫?design 鈫?testing)
...
- **Policy Analysis**: Focuses on evaluating policy effectiveness 鈥?"Is this policy working?" "Are there better policy options?"
- **Legal Case Analysis**: Focuses on analyzing legal texts and case law 鈥?"What does the law say?" "How do courts interpret it?" "Are there legal loopholes?"
...
1. Reflective Practice
   ...
   - Establish reflective framework (e.g., Sch枚n's reflection-in-action / reflection-on-action)
...
鈹溾攢鈹€ "What is known?" 鈫?Systematic Literature Review
鈹溾攢鈹€ "How do cases compare?" 鈫?Comparative Case Study
鈹溾攢鈹€ "Is this policy working?" 鈫?Policy Analysis
鈹溾攢鈹€ "What's happening and why?" 鈫?Mixed Methods
鈹溾攢鈹€ "What do documents reveal?" 鈫?Content Analysis
鈹溾攢鈹€ "How is this experienced?" 鈫?Exploratory Research
鈹溾攢鈹€ "How do we compare?" 鈫?Benchmarking Study
鈹溾攢鈹€ "Which technology should we use?" 鈫?Technology Requirements Analysis
鈹溾攢鈹€ "What does the law say?" 鈫?Legal Case Analysis
鈹斺攢鈹€ "What knowledge emerges from practice?" 鈫?Creative/Practice-Based Research

More nuanced decision:
鈹溾攢鈹€ Technology assessment related
鈹?  鈹溾攢鈹€ Comparing different technology options 鈫?Pattern 8 (Technology Requirements Analysis)
鈹?  鈹斺攢鈹€ Comparing technology adoption across organizations 鈫?Pattern 2 (Comparative Case Study)
鈹溾攢鈹€ Law/policy related
鈹?  鈹溾攢鈹€ What legal texts prescribe and how courts interpret them 鈫?Pattern 9 (Legal Case Analysis)
鈹?  鈹斺攢鈹€ Whether a policy is effective and how to improve it 鈫?Pattern 3 (Policy Analysis)
鈹溾攢鈹€ Creative/design related
鈹?  鈹溾攢鈹€ Generating knowledge through the creative process 鈫?Pattern 10 (Creative/Practice-Based Research)
鈹?  鈹溾攢鈹€ Understanding the experience of creators 鈫?Pattern 6 (Exploratory Research)
鈹?  鈹斺攢鈹€ Analyzing creative texts/works 鈫?Pattern 5 (Content Analysis)
鈹斺攢鈹€ Uncertain
    鈹溾攢鈹€ New topic with scarce literature 鈫?Pattern 6 (Exploratory Research)
    鈹溾攢鈹€ Complex problem requiring multiple data types 鈫?Pattern 4 (Mixed Methods)
    鈹斺攢鈹€ First see how others have approached it 鈫?Pattern 1 (Systematic Literature Review)
```
