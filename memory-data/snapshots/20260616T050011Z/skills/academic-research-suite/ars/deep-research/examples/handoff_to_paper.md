# Handoff Example: deep-research 鈫?academic-paper
...
- Taiwan HEEACT reports "high adoption" but academic literature suggests
  most universities are still in pilot phase 鈫?definition of "adoption" varies
...
Step 2: SECTION WRITING (Parallel)
  [review_writer_agent] 鈫?Literature Review
...
Step 3: DISCUSSION + BOOKENDS
  [discussion_writer_agent] 鈫?Discussion
  ...
  [bookend_agent] 鈫?Introduction + Conclusion
...
Step 5: SELF-REVIEW
  [review_agent]
    - Internal consistency check (RQ 鈫?Method 鈫?Findings 鈫?Discussion logic chain)
