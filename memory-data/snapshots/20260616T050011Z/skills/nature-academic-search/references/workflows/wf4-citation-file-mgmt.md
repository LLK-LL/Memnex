...
**Uses:** `scripts/format-converter.py` 鈥?multi-source downloader (PubMed/CrossRef/arXiv) with .nbib/.ris/.bib output.

## Procedure

1. **Identify papers** 鈥?by PMID, DOI, arXiv ID, or search query.
