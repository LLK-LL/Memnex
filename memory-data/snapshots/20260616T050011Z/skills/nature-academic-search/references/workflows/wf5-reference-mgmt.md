...
**Uses:** [Dedup Engine](../dedup-engine.md) 鈥?for 5a (related papers overlap).
...
1. DOI 鈫?`search_crossref` 鈫?format as BibTeX.
2. PMID 鈫?`pubmed_fetch_articles` 鈫?format as BibTeX.
