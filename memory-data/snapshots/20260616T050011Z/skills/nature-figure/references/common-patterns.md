# Common Patterns 鈥?Nature Figure Making
...
For 3鈥? metrics compared across many methods, use a wide canvas so bars and labels don't crowd.
...
**Rule**: Width often 3鈥?脳 height. Allows left-to-right narrative scanning.
...
Never use 0鈥?00 when all values are in 80鈥?5.
...
# Full method 鈫?alpha=1.0, most ablated 鈫?alpha=0.2
```
...
Use when one mechanism or fabrication story needs to lead, with 2鈥? smaller evidence plots below.
...
- Allocate `45鈥?0%` of total height to the hero schematic.
...
- [SKILL.md](../SKILL.md) 鈥?When to use this skill
- [api.md](api.md) 鈥?Helper function signatures and PALETTE
- [design-theory.md](design-theory.md) 鈥?Rationale behind every pattern above
- [nature-2026-observations.md](nature-2026-observations.md) 鈥?Real Nature page archetypes behind these patterns
- [tutorials.md](tutorials.md) 鈥?End-to-end walkthroughs
- [chart-types.md](chart-types.md) 鈥?Radar, 3D, scatter patterns
- [demos.md](demos.md) 鈥?Bundled figures4papers scripts and previews
