# Round 2: Journal-Conformity Revision 鈥?Detailed Instructions
...
## Phase 0: The Three R's 鈥?Corpus-Based Style Calibration
...
**R1 鈥?Recalibration**: Align word usage with field standards.
- Compare your Round 1 draft against all 3 journal papers for each key term
- Does this word appear with the same frequency? Example: if journal papers use "demonstrate" 15脳 and "show" 2脳, recalibrate toward "demonstrate"
- Check: verb+noun pairs, adjective+noun pairs, preposition choices

**R2 鈥?Replacement**: Choose context-appropriate alternatives.
- For overused or non-standard words, use the journal papers' concordance to find field-preferred synonyms
- Example: if our draft says "important" 20脳 but journal papers use "critical", "essential", "fundamental", "central" contextually, replace accordingly
...
**R3 鈥?Redevelopment**: Holistic revision from corpus insights.
...
|---|---------------------|-----------|-------------------|--------|
| R1 | "show" vs "demonstrate" | "show" 25脳 | "demonstrate" 15脳, "show" 2脳 | Replace most "show" 鈫?"demonstrate" |
| R2 | "important" | 20脳 | varied: "critical", "essential" | Diversify |
...
- [ ] Section length ratios within 卤10% of journal averages [list targets]
