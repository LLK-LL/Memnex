...
- Figures and tables are images embedded in the page 鈥?crop them per `references/figure-extraction.md`; do not paste the page text of a table where the table image belongs.
