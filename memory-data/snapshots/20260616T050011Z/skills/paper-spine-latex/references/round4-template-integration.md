# Round 4: LaTeX Template Integration & Compilation 鈥?Detailed Instructions
...
1. **Preamble consistency**: Does the preamble match the official template files?
   ...
   - Custom macro definitions (`\newcommand` blocks) 鈥?preserved from Round 3
...
鈹溾攢鈹€ <main_tex_filename>.tex    # Main LaTeX document (the filled template)
鈹溾攢鈹€ Fig/ or figures/            # Figure files
鈹溾攢鈹€ reference.bib               # Bibliography
鈹溾攢鈹€ [template files]            # cls, sty, bst files
鈹溾攢鈹€ supplementary.tex           # If applicable
鈹斺攢鈹€ paper_rewriting_output/     # All intermediate outputs
```
