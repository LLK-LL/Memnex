...
- Methods-heavy paper 鈫?shift toward `~1,200 / 1,800 / 700 / 1,800` (Intro / Results / Disc / Methods)
- Bio/clinical with rich Results 鈫?shift toward `~600 / 2,400 / 800 / 1,200`
...
- Reporting Summary 鈥?fill with the same rigor as the manuscript itself; reviewers see it
- Cover letter (separate upload) 鈥?three sentences: what / what's new / why cross-disciplinary

## Display-item planning

- 10-item cap (figures + tables combined)
- **No Extended Data tier** 鈥?anything beyond 10 goes to Supplementary Information
...
- Lead with the finding, not the background 鈥?editors triage on the abstract
