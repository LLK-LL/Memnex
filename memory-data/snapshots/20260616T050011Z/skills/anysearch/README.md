...
```
anysearch/
鈹溾攢鈹€ .env.example              # API key configuration template
鈹溾攢鈹€ .env                      # Your API key (gitignored, create from .env.example)
鈹溾攢鈹€ runtime.conf              # Detected runtime preferences (gitignored)
鈹溾攢鈹€ runtime.conf.example      # Runtime configuration template
鈹溾攢鈹€ SKILL.md                  # Skill definition for AI agents
鈹溾攢鈹€ README.md                 # This file
鈹斺攢鈹€ scripts/
    鈹溾攢鈹€ anysearch_cli.py       # Python CLI
    鈹溾攢鈹€ anysearch_cli.js       # Node.js CLI
    鈹溾攢鈹€ anysearch_cli.ps1      # PowerShell CLI
    鈹斺攢鈹€ anysearch_cli.sh       # Bash CLI
```
