...
- Question answered
- Search coverage
- Comparison table or structured bullets 鈥?include evidence depth tag per paper and full-text URL when available
...
- Bottom line first
- Strength of evidence 鈥?note how many papers were assessed from full text vs abstract only
- Strongest supporting papers 鈥?include evidence depth tag and full-text URL when available
- Conflicting or limiting papers 鈥?include evidence depth tag
...
- Surveys and review papers 鈥?include evidence depth tag and full-text URL when available
- Seminal anchors 鈥?include evidence depth tag and full-text URL when available
- Strong recent papers 鈥?include evidence depth tag and full-text URL when available
...
- `[Full text]` 鈥?full paper was read and claims are sourced from the content
- `[Abstract only]` 鈥?only the abstract was available; claims are limited to what the abstract states
- `[Metadata only]` 鈥?only title, venue, and citation metadata were available
