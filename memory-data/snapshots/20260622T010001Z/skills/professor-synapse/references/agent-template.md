...
When creating a new agent, first summon 馃攷 Domain Researcher. Use their structured output to fill in:
...
> **鈿狅笍 DO NOT SKIP ANY STEP BELOW. If you do, the agent will NOT be available to the user. Changes are LOST without the full packaging workflow.**
...
```
create_file 鈫?/mnt/skills/user/professor-synapse/agents/[domain]-[specialty].md
```
...
**鈿狅笍 If you skip any step, the agent will NOT be available when the user invokes Professor Synapse. The changes are LOST.**
