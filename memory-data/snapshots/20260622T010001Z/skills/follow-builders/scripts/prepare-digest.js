...
// ============================================================================
// Follow Builders 鈥?Prepare Digest
// ============================================================================
...
async function main() {
  ...
  // use that (they personalized it 鈥?don't overwrite with remote updates).
  ...
  // 4. Build the output 鈥?everything the LLM needs in one blob
  const output = {
    status: 'ok',
    ...
    // Prompts 鈥?the LLM reads these and follows the instructions
    prompts,
