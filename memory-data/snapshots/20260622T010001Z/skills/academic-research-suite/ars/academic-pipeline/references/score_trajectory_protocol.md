...
Tracks how rubric scores change across revision rounds. Detects score regressions 鈥?dimensions where the revised paper scores lower than the original 鈥?which indicate that a revision fix inadvertently damaged another aspect of the paper.
...
- Song, Y. et al. (2026). PaperOrchestra. *arXiv:2604.05018*. 鈥?Section 4 Step 5 (Content Refinement Agent: score-driven accept/revert).
