...
**User**: I think the most important thing is the freshmen enrollment rate 鈥?if you can't recruit students, nothing else matters.
...
**User**: Because the declining birthrate is already happening 鈥?many universities might close within 5 years.
