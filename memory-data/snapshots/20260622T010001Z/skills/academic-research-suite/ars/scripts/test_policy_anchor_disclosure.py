...
logic encoded in policy_anchor_disclosure_protocol.md 搂2 (G10 7-row
table) and 搂4 (auto-promotion forbiddance). It is not the production
runtime 鈥?production is LLM-prose at execution time 鈥?but it provides
deterministic conformance testing that fails when the protocol doc and
the reference impl drift.

Each test asserts (input 鈫?expected G10 row decision + acceptable per-
...
Cross-reference: impl spec 搂3 (resolved-paths table), 搂4 (TDD discipline),
搂6 (test count expectation).
"""
...
# ============================================================================
# 搂3 G10 7-row precedence table 鈥?positive fixtures per row
# ============================================================================
...
# ============================================================================
# 搂4 Auto-promotion forbiddance 鈥?load-bearing negative tests
# ============================================================================
...
# ============================================================================
# 搂4.3 G1 invariant 鈥?no entry-level field touched
# ============================================================================
...
# ============================================================================
# 搂4.3 G2 invariant 鈥?track gate by slr_lineage
# ============================================================================
class G2InvariantTest(unittest.TestCase):
    def test_prisma_track_requires_slr_lineage(self) -> None:
        # slr_lineage=False with --policy-anchor=prisma-trAIce 鈫?rejected
...
# ============================================================================
# 搂4.3 G5 invariant 鈥?three-gate composition for M6 prompt disclosure
# ============================================================================
...
# ============================================================================
# 搂4.3 G7 invariant 鈥?anchor-specific carve-out semantics
# ============================================================================
...
# ============================================================================
# 搂4.3 G8 invariant 鈥?IEEE #5 + #6 paired mandate
# ============================================================================
class G8InvariantTest(unittest.TestCase):
    ...
    def test_ieee_row_4_render_passes_when_neither_pairing_input_present(self) -> None:
        ...
        # proceeds 鈥?the missing pairing surfaces as a per-facet "not
        # supplied" annotation downstream (per protocol 搂3.4); it is not
...
# ============================================================================
# 搂4.3 G9 invariant 鈥?anchor-specific image-rights regimes
# ============================================================================
...
# ============================================================================
# 搂4.4 #1 鈥?slr_lineage signal, no upstream chasing
# ============================================================================
...
# ============================================================================
# 搂4.4 #5 鈥?Nature hybrid image output channel
# ============================================================================
...
# ============================================================================
# 搂4.4 #6 鈥?UNCERTAIN per-facet annotation
# ============================================================================
...
# ============================================================================
# 搂4.4 #7 鈥?venue+anchor conflict resolution
# ============================================================================
...
class NaturePortfolioVariantTest(unittest.TestCase):
    def test_nature_medicine_with_nature_anchor_passes(self) -> None:
        ...
        # Nature Climate Change, Nature Communications, 鈥? all inherit
...
# ============================================================================
# 搂4.4 #10 鈥?ai_used:true substantive-content gate
# ============================================================================
class Concern10Test(unittest.TestCase):
    ...
    def test_bare_ai_used_true_all_not_used_triggers_categorization_flow(self) -> None:
        ...
        # (row 1 needs USED) 鈫?caught by concern #10 gate. Codex round-5
        # P2 #2: protocol 搂3 G10 row 4 sub-gate spec extended to cover
...
# ============================================================================
# 搂4.4 #11 鈥?G1 invariant scope narrowing (data layer untouched, plumbing OK)
# ============================================================================
