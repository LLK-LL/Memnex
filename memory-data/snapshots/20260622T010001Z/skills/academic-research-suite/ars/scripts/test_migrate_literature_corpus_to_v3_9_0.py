...
Tests scripts/migrate_literature_corpus_to_v3_9_0.py 鈥?the CLI that
backfills `openalex_unmatched` and `crossref_unmatched` on v3.7.3-onward
literature_corpus[] entries per v3.9.0 spec 搂3.7.
...
# REDACTED: sensitive-looking memory line
            ...
            before = p.read_bytes()
            # OpenAlex/Crossref return no match 鈥?would set True on real run.
...
# REDACTED: sensitive-looking memory line
            ...
            # OpenAlex: DOI matches 鈫?openalex_unmatched=False
            # Crossref: DOI miss, title miss 鈫?crossref_unmatched=True
...
# ============================================================================
# 4. Pre-v3.7.3 entry: no semantic_scholar_unmatched 鈫?out of scope
# ============================================================================
...
# ============================================================================
# 6. Partial degradation: one field absent, one populated 鈥?only fills missing
# ============================================================================
class PartialDegradationTest(unittest.TestCase):
    def test_partial_degradation_fills_only_missing_field(self) -> None:
        ...
        OpenAlex now up 鈫?openalex_unmatched filled; crossref_unmatched preserved.
...
# REDACTED: sensitive-looking memory line
                ...
                "contamination_signals": {
                    ...
                    # openalex_unmatched absent 鈥?to be filled
                },
            }])
            # OpenAlex: DOI match 鈫?False
