...
class LintScriptTest(unittest.TestCase):
    def test_lint_passes_on_current_repo_state(self) -> None:
        # The lint MUST pass on the shipped repo 鈥?Step 8 commit cluster
        # closed the 搂3.6 + REFUSE list rules 6-10. A failure here means a
...
# REDACTED: sensitive-looking memory line
    ...
    def test_lint_detects_renamed_constant_missing_from_formatter(self) -> None:
        ...
        # existing HIGH-WARN constant's literal (e.g. CLAIM-NOT-SUPPORTED 鈫?
        ...
        # gate doesn't fire first 鈥?the real failure mode is the literal-
        ...
        with tempfile.TemporaryDirectory() as td:
            ...
            # Rename the CLAIM-NOT-SUPPORTED literal in place 鈥?the formatter
