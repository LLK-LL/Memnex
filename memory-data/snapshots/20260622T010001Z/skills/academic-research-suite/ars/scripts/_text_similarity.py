...
Extracted in #128 (v3.9.1 housekeeping) to prevent sibling drift 鈥?any
...
# Per protocol: 429 鈫?2s backoff 脳 3 retries. Shared budget across S2 /
# OpenAlex / Crossref clients.
_BACKOFF_SECONDS = 2.0
_MAX_RETRIES = 3


# Per PaperOrchestra (Song et al. 2026 Appx D.3) + protocol 搂"Query Patterns"
# Pattern 1: title-similarity threshold for "matched" verdict.
_TITLE_SIMILARITY_THRESHOLD = 0.70


def _normalize_title(s: str) -> str:
    """Per protocol 搂"Query Patterns" Pattern 1: 'case-insensitive, stripped
