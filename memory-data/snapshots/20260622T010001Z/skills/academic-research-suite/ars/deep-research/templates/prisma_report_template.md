# PRISMA 2020 鈥?Systematic Review Report Template
...
| [Other sources: reference lists, expert contact, grey literature] | 鈥?| [date] |
...
```
 ...
 鈹?  Reference lists (n = )                            鈹?
 鈹?  Expert recommendations (n = )                     鈹?
 ...
 鈹?  Records marked ineligible by automation (n = )    鈹?
 ...
 鈹?Studies in quantitative synthesis (n = )             鈹?
...
- Heterogeneity: I虏 = [value]% (95% CI: [lower, upper]), Q = [value] (df = [n], p = [value]), tau虏 = [value]
...
1. Leave-one-out: [results 鈥?did any single study substantially change the estimate?]
