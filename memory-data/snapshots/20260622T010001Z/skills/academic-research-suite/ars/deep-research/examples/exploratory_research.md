# Example: Exploratory Research 鈥?Full Pipeline
...
- Minor: RQ is broad 鈥?consider whether "emerging" limits to recent literature only
...
2. Source #19 鈥?Currency concern (2019 review may not reflect post-GPT developments)
...
**Key Contradiction**: Sources disagree on whether AI reduces or amplifies bias in QA 鈥?resolution depends on implementation design and oversight mechanisms.
...
**Verdict**: PASS
- Minor: Technology-positive framing detected 鈥?ensure risks are given equal weight
...
- All references spot-checked (5/22 = 23%) 鈥?all verified
- Dual-use risk: Low
...
**Verdict**: PASS
- Observation: Conclusion recommendation #3 ("QA agencies should adopt AI tools") is stronger than evidence warrants 鈥?suggest hedging
- "So what?" test: Passed 鈥?clear implications for QA practice
