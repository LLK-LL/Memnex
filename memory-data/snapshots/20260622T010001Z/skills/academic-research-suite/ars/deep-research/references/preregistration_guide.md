# Preregistration Guide 鈥?Research Preregistration Guide
...
鈹?
鈹溾攢鈹€ Confirmatory research (hypothesis testing)
鈹?  鈹斺攢鈹€ Strongly recommend preregistration
鈹?      鈹溾攢鈹€ Has pre-specified statistical hypotheses 鈫?Preregister
鈹?      鈹溾攢鈹€ Will conduct significance testing 鈫?Preregister
鈹?      鈹斺攢鈹€ Has primary outcome variables 鈫?Preregister
鈹?
鈹溾攢鈹€ Exploratory research
鈹?  鈹斺攢鈹€ Preregistration not required (but optional)
鈹?      鈹溾攢鈹€ Qualitative research 鈫?Typically not preregistered
鈹?      鈹溾攢鈹€ Data mining / EDA 鈫?Typically not preregistered
鈹?      鈹斺攢鈹€ But you can preregister the research design and analysis process
鈹?
鈹溾攢鈹€ Systematic review / Meta-analysis
鈹?  鈹斺攢鈹€ Strongly recommend registration (PROSPERO)
鈹?      鈹斺攢鈹€ Many journals require systematic reviews to be pre-registered
鈹?
鈹溾攢鈹€ Randomized controlled trial (RCT)
鈹?  鈹斺攢鈹€ Must register
鈹?      鈹溾攢鈹€ ICMJE requires RCTs to be pre-registered
鈹?      鈹斺攢鈹€ Most journals will not accept unregistered RCTs
鈹?
鈹溾攢鈹€ Replication study
鈹?  鈹斺攢鈹€ Strongly recommend preregistration
鈹?      鈹斺攢鈹€ Preregistration clearly distinguishes original from modified hypotheses
鈹?
鈹斺攢鈹€ Secondary data analysis
    鈹斺攢鈹€ Recommend preregistration
        鈹斺攢鈹€ Prevents HARKing (Hypothesizing After Results are Known)
```
...
鈹?
鈹溾攢鈹€ Systematic review / meta-analysis 鈫?PROSPERO
鈹溾攢鈹€ Clinical trial / medical intervention 鈫?ClinicalTrials.gov
鈹溾攢鈹€ Economics RCT 鈫?AEA Registry
鈹溾攢鈹€ Just need simple preregistration 鈫?AsPredicted
鈹斺攢鈹€ All other research 鈫?OSF Registries (recommended)
```
...
- Gender 脳 teaching method interaction effect
...
鈹溾攢鈹€ Introduction (theoretical background, literature review)
鈹溾攢鈹€ Methods (complete methodology, analysis plan)
鈹溾攢鈹€ Pilot data (if available)
鈹斺攢鈹€ Interpretation plan for predicted results
         鈫?
Stage 1 Review (research design quality)
鈹溾攢鈹€ Accept (In-Principle Acceptance, IPA)
鈹溾攢鈹€ Revise and resubmit
鈹斺攢鈹€ Reject
         鈫?
Stage 2: Conduct research, write results
鈹溾攢鈹€ Strictly follow the Stage 1 plan
鈹溾攢鈹€ Report all preregistered analyses (including null results)
鈹溾攢鈹€ Exploratory analyses clearly labeled
鈹斺攢鈹€ Deviations disclosed and explained
         鈫?
Stage 2 Review (execution quality)
鈹溾攢鈹€ Was the Stage 1 plan faithfully executed?
鈹溾攢鈹€ Are results reported completely?
鈹斺攢鈹€ Typically not rejected due to null results
         鈫?
Publication
```
