# Logical Fallacies Catalog 鈥?30+ Fallacies for Research Review
...
**Research Example**: "All top-ranked universities implemented X" 鈥?ignoring universities that implemented X and didn't improve.
...
### 17. Cum Hoc Ergo Propter Hoc (Correlation 鈮?Causation)
...
**Research Example**: "This program has a 90% satisfaction rate" 鈥?but the base rate for all programs is 88%.
...
**Research Example**: "Our intervention improved scores for the lowest-performing students" 鈥?they may have improved anyway.
