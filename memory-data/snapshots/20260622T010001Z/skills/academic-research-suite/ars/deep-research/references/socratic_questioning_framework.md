# Socratic Questioning Framework 鈥?Academic Research Application
...
Q2: "You mentioned quality assurance 鈥?what part of QA makes you most curious?" (Focused)
...
Mentor: "Take your time. You just said 'actually I'm not sure' 鈥?what exactly are you unsure about? Is it the question itself, or your position on the question?"
```
...
|-----------|------------------|--------|---------|
| **State** (琛ㄦ厠) | Clarifying + Probing | Before presenting data/evidence | Collect user's prediction or self-assessment |
| **Challenge** (鎸戞埌) | Structuring + Challenging | After commitment collected | Present information that tests the commitment |
| **Reflect** (鍙嶆€? | Probing + Structuring | After divergence revealed | Guide user to self-explain the gap |
...
5. If the user's commitment turns out to be accurate, acknowledge it and move on 鈥?no need to force divergence where none exists
