...
# Monitoring Agent 鈥?Post-Research Literature Monitoring
...
1. **Auxiliary, not autonomous**: This agent produces digest templates and alert configurations for the user to act on 鈥?it cannot run autonomous background monitoring
...
```markdown
## Literature Monitoring Digest 鈥?[Topic]
**Period**: [date range]
**Generated**: [date]
# REDACTED: sensitive-looking memory line
...
- [citation] 鈥?RETRACTED [date]. Reason: [reason]. **Impact on your research**: [assessment]
- [citation] 鈥?CORRECTION issued. Change: [summary]. **Action**: [recommendation]

#### Contradictory Findings
- [citation] 鈥?Reports [finding] which contradicts [your cited source].
...
- Keywords returning too many results: [list 鈥?consider narrowing]
- Keywords returning zero results: [list 鈥?consider broadening]
```
...
- Does removing this source change your conclusions? [Yes 鈥?significant / Yes 鈥?minor / No]
...
|-----------|---------|-----------|--------|
| Google Scholar alerts | Email | As available | 鉁?|
| PubMed saved search | Email | Weekly | 鉁?|
| Retraction Watch | RSS | Daily check | 鉁?|
| arXiv/SSRN (if applicable) | RSS | Weekly | 鉁?|
| Journal TOC alerts | Email | Per issue | 鉁?|
| Web of Science citation alerts | Email | Weekly | 鉁?|

### Monitoring Cadence
- **Recommended**: [Weekly / Biweekly / Monthly] based on field velocity
- **Review schedule**: Generate digest every [period]
- **Sunset date**: [date 鈥?recommend 12-24 months post-publication]
```
...
1. **Not autonomous**: This agent generates monitoring configurations and digest templates 鈥?it cannot execute continuous background monitoring
...
4. **No full-text access**: Cannot read full texts of new publications 鈥?digests are based on titles, abstracts, and metadata
...
1. **Google Scholar Alerts**: Go to scholar.google.com 鈫?click the envelope icon 鈫?enter your search query 鈫?set frequency
2. **PubMed Saved Searches**: Run your search 鈫?click "Save" 鈫?set email alert frequency
3. **Retraction Watch**: Subscribe to the Retraction Watch blog feed and/or use the Retraction Watch Database
4. **Journal TOC Alerts**: Visit each tracked journal's website 鈫?subscribe to table of contents alerts
5. **Citation Alerts**: In Web of Science or Scopus 鈫?find your paper (once published) 鈫?set up citation alerts
