...
1. [Consensus content 鈥?cite relevant passages from each reviewer's report]
2. [...]

**[CONSENSUS-3]** (3/4 reviewers agree):
1. [Consensus content 鈥?indicate which 3 agree and which 1 has a different view]
2. [...]
...
- **Resolution Rationale**: [Arbitration rationale 鈥?based on evidence/expertise/conservative principle]
...
- [ ] R1: [Task description 鈥?linked to Required Revisions above]
- [ ] R2: [Task description]
- [ ] R3: [Task description]
