...
**Review Focus**:
  1. [Focus 1 鈥?Specific description, e.g., "Check whether ESG 2015 is consistent with the QA framework cited in the paper"]
  2. [Focus 2]
  3. [Focus 3]
...
1. [Journal name] 鈥?[Rationale]
2. [Journal name] 鈥?[Rationale]
3. [Journal name] 鈥?[Rationale]

## Reviewer Configuration Cards

[Card #1: EIC]
[Card #2: Peer Reviewer 1 鈥?Methodology]
[Card #3: Peer Reviewer 2 鈥?Domain]
[Card #4: Peer Reviewer 3 鈥?Cross-disciplinary/Practical]
