...
**After**: Specific numbers ("2鈥?脳"), named mechanisms, or deleted entirely.
...
**Principle**: If the venue's reviewers already know it, it doesn't belong. The only exception: when the paper redefines a known concept in a new way 鈥?then the redefinition IS the contribution.
...
**After (claim-first)**: "System X outperforms all baselines by 2鈥?脳" / "Why do linear approaches fail?"
...
**Principle**: The reader doesn't need every number 鈥?they need the PATTERN. Takeaway paragraphs compress results into interpretations.

---

## Pattern 7: Figure/Table Promotion (Text 鈫?Visual)
...
|---|---|
| 10鈥?0% | Draft was already close to final form. Light polish needed. |
# REDACTED: sensitive-looking memory line
| 50鈥?5% | Crisis compression 鈥?the framing changed fundamentally. Content was cut because the narrative shifted, not because it was wordy. |
