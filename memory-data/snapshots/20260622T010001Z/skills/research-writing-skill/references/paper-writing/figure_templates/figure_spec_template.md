...
- **What it shows:** [1-2 sentences 鈥?what should the reader understand after looking at this figure?]
...
- **Size target:** [single-column (3.33in) / full-width (7.0in) 鈥?adjust per venue from venue_styles.md]

## Styling

- **Color mapping:** [which semantic category maps to which palette color]
- **Emphasis:** [which component is the paper's key contribution 鈥?should be visually prominent via color, border weight, or size]
...
<!-- representations, enabling per-event feature extraction (搂3.2) and embedding-based -->
<!-- similarity search (搂3.3)." -->
...
- **Generated:** [yes / no 鈥?date if yes]
