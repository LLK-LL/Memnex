...
- Separate `鍘熸枃/宸叉湁鏁版嵁`, `鐢ㄦ埛纭鍐呭`, `鏍规嵁涓婁笅鏂囨帹鏂璥, and `寤鸿鎬ф墿灞昤.
...
- Replace vague words such as "鏄捐憲", "鍏堣繘", "鏈夋晥", "椴佹" with measured conditions, comparison baselines, or remove them.
...
These references come from an external systems/networking-oriented repository. Treat them as optional craft guidance, not binding rules, and adapt them to鍏夌數淇℃伅绉戝涓庡伐绋? optics, optoelectronics, sensing, communication, signal processing, and MATLAB simulation work.
