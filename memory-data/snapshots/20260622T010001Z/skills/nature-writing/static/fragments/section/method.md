...
1. **Motivation** 鈥?what problem this module solves, and why the obvious alternative fails
2. **Mechanism** 鈥?what the module actually does, to a level a peer could re-implement
3. **Evidence / role** 鈥?how this module contributes to the overall result (ablation hook)
...
- Reproducibility scope: code, weights, data 鈥?what will be released.
