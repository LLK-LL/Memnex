...
- `s41586-026-10408-8` 鈥?wide schematic-led materials figure with supporting quant panels
- `s41586-026-10426-6` 鈥?dark whole-brain image plate with repeated views
- `s41586-026-10393-y` 鈥?clinical triptych: longitudinal lines, forest plots, summary bars
- `s41586-026-10257-5` 鈥?dense categorical stacked-area panels with direct labels
- `s41586-026-10439-1` 鈥?asymmetric genomics figure with one dominant circular panel
- `Expert-level detection of pathologies...` 鈥?compact medical / ML figure conventions
...
- Let the schematic occupy roughly `45鈥?0%` of figure height.
