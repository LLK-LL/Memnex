# Tutorials 鈥?Nature Figure Making
...
- [api.md](api.md) 鈥?Reusable helper implementations
- [common-patterns.md](common-patterns.md) 鈥?Layout and encoding patterns used above
- [design-theory.md](design-theory.md) 鈥?Why these choices exist
- [chart-types.md](chart-types.md) 鈥?Radar, 3D sphere, scatter, fill_between
