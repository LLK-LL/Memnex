...
def synth_whoosh():
    ...
    for i in range(n):
        ...
        # Frequency sweep: bandpass center 200鈫?500鈫?00
        progress = i / n
        if progress < 0.43:
...
def main():
    ...
    print(f"馃攰 Rendering SFX to {OUTPUT_DIR}/\n")
    ...
    for name, synth_fn in sounds.items():
        ...
        print(f"  鉁?{name}.wav ({dur*1000:.0f}ms, {size/1024:.1f}KB)")

    print("\n鉁?Done! Add these to HyperFrames with <audio> tags.")
