...
2. Modern academic Chinese
   ...
   - Remove spoken phrasing such as `鎴戜滑瑙夊緱` and replace it with objective description when needed.
3. Logic and flow
