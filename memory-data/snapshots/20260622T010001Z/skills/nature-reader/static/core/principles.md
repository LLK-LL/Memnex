...
When the user asks for paper translation, reading, `nature-reader`, `涓嫳鏂囧鐓, `鍘熸枃瀵圭収`, `鍏ㄦ枃缈昏瘧`, or `缈昏瘧瑙ｈ`, produce a paragraph-level bilingual reader by default.
...
**涓枃:** [faithful Chinese translation]
```
